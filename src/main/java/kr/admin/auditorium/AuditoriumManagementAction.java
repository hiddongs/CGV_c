...
public class AuditoriumManagementAction implements Action{
	...
	public String execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String jsonAuditoriumList = mapper.writeValueAsString(auditoriumList);
		req.setAttribute("auditoriumList", jsonAuditoriumList);
		req.setAttribute("theaterId", theaterId);
		
		return "admin/auditorium/auditoriumManagement.jsp";
	}
