    ...
    <main>
        ...
        <form action="register.do" method="post" id="register_form">
            ...
            <div>
            	...
            	<input type="radio" name="mem_gender" id="mem_gender" required="required" value="M"> 남성
            	<input type="radio" name="mem_gender" id="mem_gender" required="required" value="F"> 여성
            </div>
            <br>
            <div class="form-group">
            ...
            <div class="form-group">
				...
				<input type="hidden" name="zipcode" id="zipcode"
					             ...
					             autocomplete="off">
				<button class="btn btn-secondary" type="button" onclick="execDaumPostcode()">주소찾기</button>           
            </div>
            <div class="form-group">
