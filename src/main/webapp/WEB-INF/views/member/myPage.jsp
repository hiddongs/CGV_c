...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/leftMenu.css">
	...
	<div class="container">
		<div class="mypage-container">
			<div class="mypage-header">
				<h2>${member.name}님
					<span class="vip-tag">${member.grade} 등급</span>
				</h2>
			...
			<div class="mypage-section">
				<div class="mypage-item">
					<div class="mypage-label">
						<!-- 나의 예매 목록으로 이동 -->
						<a
							href="${pageContext.request.contextPath}/reservation/reservationList.do"
							style="text-decoration: none; color: inherit;">> 나의 예매내역</a>
						<div class="mypage-content">
							<!-- 영화 구매 목록 -->
							<c:forEach var="reservation" items="${reservationList}">
								<h3>${reservation.mvTitle}</h3>
								<div class="mypage-date">${reservation.screeningDate}|
									${reservation.name} |${reservation.viewers}명
									|${reservation.pMovie}원</div>
							</c:forEach>
						</div>
					</div>
				</div>
			...
			<!-- 할인권 -->
			<div class="mypage-item">
				<a href="${pageContext.request.contextPath}/member/mypageCoupon.do"
					style="text-decoration: none; color: inherit;">
					<div class="mypage-label">> 할인쿠폰 관리
				</a>
			</div>
			<c:forEach var="coupon" items="${couponList}">
				<div>
					<strong> ${coupon.couponName}</strong><br> 할인 금액:
					${coupon.discountAmount}원 | 유효기간 : ${coupon.expired_date}
				</div>
			</c:forEach>

			<!-- 문의사항 : ask-->
			<div class="mypage-item">
				<a href="${pageContext.request.contextPath}/notice/ask.do"
					style="text-decoration: none; color: inherit;">
