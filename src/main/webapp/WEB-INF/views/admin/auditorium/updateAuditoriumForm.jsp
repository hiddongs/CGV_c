...
<body>
    ...
    <form action="updateAuditorium.do" class="form-container" method="post">
        <input type="hidden" id="auditoriumId" name="auditoriumId" value="${auditorium.auditoriumId}">
        <input type="hidden" id="theaterId" name="theaterId" value="${auditorium.theaterId}">
        <h3 class="form-title">관리자 상영관수정 페이지</h3>
        <div class="form-group">    
            <label for="name" class="form-label">상영관 이름</label>
            <input type="text" class="form-input" id="name" name="name" value="${auditorium.name}">
        </div>
        <div class="form-group">
