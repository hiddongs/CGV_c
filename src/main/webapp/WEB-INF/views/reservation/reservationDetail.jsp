	...
	<div class="container">
        <div class="ticket-container">
            ...
            <div class="ticket-info">
                ...
                <div class="info-grid">
                    <div class="info-item">
                   <!-- 관람극장은 Join해서 select하기 -->
                        <div class="info-label">관람극장</div>
                        <div class="info-value">${reservation.theaterID}
                        <a href="${pageContext.request.contextPath}/theater/selectTheater.do?theaterID=${reservation.theaterID}" class="info-button">[극장정보]</a> 
                    </div>
                    
                    <div class="info-item">
                        <div class="info-label">관람인원</div>
                        <div class="info-value">${reservation.viewers}명</div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value">${reservation.totalPrice}원</div>
                    </div>
                </div>
            </div>
